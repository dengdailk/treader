...
public class FileAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.textView = convertView.findViewById(R.id.tv_file_text);
            viewHolder.textSize = convertView.findViewById(R.id.tv_file_text_size);
            viewHolder.fileIcon = convertView.findViewById(R.id.iv_file_icon);
            viewHolder.checkBox = convertView.findViewById(R.id.cb_file_image);
            viewHolder.linearLayout = convertView.findViewById(R.id.ll_file_lin);
